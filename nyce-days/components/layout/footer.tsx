      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="md:col-span-5">
            ...
            <p className="mt-6 font-sans text-sm text-background/70 max-w-sm leading-relaxed">
          ...
          <div className="md:col-span-3">
            <h3 className="font-sans text-xs font-medium text-background/50 uppercase tracking-widest">
              Navigation
            </h3>
            <ul className="mt-6 space-y-3">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="font-sans text-sm text-background/70 hover:text-background transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-4">
            ...
            <p className="mt-6 font-sans text-sm text-background/70 leading-relaxed">
            ...
            {/* Social Links */}
            <div className="mt-8">
              <h4 className="font-sans text-xs font-medium text-background/50 uppercase tracking-widest">
                Follow Us
              </h4>
        ...
        <div className="mt-16 pt-8 border-t border-background/10">
          <p className="font-sans text-xs text-background/50 text-center tracking-wide">
